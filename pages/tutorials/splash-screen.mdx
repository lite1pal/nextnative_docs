...
A polished mobile app experience starts with a well-designed splash screen and onboarding flow. NextNative provides components and hooks to make this process simple and effective. This tutorial will guide you through customizing both elements for your app.

<br />
import Image from "next/image";

<Image src="/splash-screen.gif" alt="Splash screen" width={300} height={300} />
...
The in-app splash screen takes over after the native splash screen and provides a smoother transition to your app. Let's look at how it's implemented:
